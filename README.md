...
- **v1.1.0**: Added speech recognition and enhanced UI
- **v1.2.0**: Improved ATS scoring and report generation
- **v1.3.0**: Added career coaching and mobile optimization

## 🙏 Acknowledgments

- Groq for providing AI language model services
